/// SlidrSchemaV14 — Frozen schema snapshot
...
enum SlidrSchemaV14: VersionedSchema {
    ...
    static var models: [any PersistentModel.Type] {
        [SlidrSchemaV14.MediaItem.self, SlidrSchemaV14.Playlist.self, SlidrSchemaV14.AppSettings.self]
    }
    ...
    final class MediaItem {
        ...
        var playlists: [SlidrSchemaV14.Playlist]?
        var caption: String?
        var isFavorite: Bool
        var rating: Int?
        var tags: [String]
    ...
    final class Playlist {
        ...
        @Relationship(deleteRule: .nullify, inverse: \SlidrSchemaV14.MediaItem.playlists)
        var manualItems: [SlidrSchemaV14.MediaItem]?
