/// SlidrSchemaV13 — Frozen schema snapshot
...
enum SlidrSchemaV13: VersionedSchema {
    ...
    static var models: [any PersistentModel.Type] {
        [SlidrSchemaV13.MediaItem.self, SlidrSchemaV13.Playlist.self, SlidrSchemaV13.AppSettings.self]
    }
    ...
    final class MediaItem {
        ...
        var playlists: [SlidrSchemaV13.Playlist]?
        var caption: String?
        var isFavorite: Bool
        var rating: Int?
        var tags: [String]
    ...
    final class Playlist {
        ...
        @Relationship(deleteRule: .nullify, inverse: \SlidrSchemaV13.MediaItem.playlists)
        var manualItems: [SlidrSchemaV13.MediaItem]?
