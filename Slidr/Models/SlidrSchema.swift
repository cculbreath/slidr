...
enum SlidrMigrationPlan: SchemaMigrationPlan {
    static var schemas: [any VersionedSchema.Type] {
        [SlidrSchemaV1.self, SlidrSchemaV2.self, SlidrSchemaV3.self, SlidrSchemaV4.self, SlidrSchemaV5.self, SlidrSchemaV6.self, SlidrSchemaV7.self]
    }
